    ...
    if SOCKSTRUE != 0:
        ...
        def check_socks(ip, port):
            ...
            try:
                ...
                gline_socks(ip, int(time.time()), int(time.time()) + config.DURATION, port, version)
                print 'server : port  is  ', ip, ':', port, '; varsion: ', version
            except Exception as e:
                #print e
                #print "Port " + str(port) + " is dead: " + str(e)
                pass
